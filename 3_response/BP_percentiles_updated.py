...
class Data:
    ...
    def loader(self):
        data = open("Composite_sheet_cleaned.csv", "r")
        next(data)
        for line in data:
            self.global_data.append(line.strip("\n").split(','))
...
class Patient:
    ...
    def create_objects(global_data):
        patients = []
        for subject in global_data:

            patient = Patient()

            patient.record_ID = subject[0]

            if 'female' in subject[1].lower():
                patient.sex_at_birth = 2
            else:
                patient.sex_at_birth = 1
            
            patient.height = float(subject[2])

            today = date.today()
            DOB = subject[3].split('/')
            patient.age = int(round((today.year - int(DOB[2])) + ((today.month - int(DOB[1])) / 12) + ((today.day - int(DOB[0])) / 362.25), 1))

            if 'not' or 'N/A' not in subject[4]:
                inter = subject[4].split(" ")
                inter2 = inter[0].split("/")
                #print(inter2)
                patient.BP1.append(int(inter2[0]))
                patient.BP1.append(int(inter2[1]))

            if 'not' not in subject[5] and 'N/A' not in subject[5]:
                inter3 = subject[5].split(" ")
                inter4 = inter3[0].split("/")
                #print(inter4)
                patient.BP2.append(int(inter4[0]))
                patient.BP2.append(int(inter4[1]))
            
            patients.append(patient)

        return patients
    
    def percentile_calculation(patient, percentile_data):

        if patient.age not in percentile_data[patient.sex_at_birth]:
            print("Patient is not pediateric according to calculator and study")
            return "Patient is not pediateric"

        closest_index = None
        for i, height in enumerate(percentile_data[patient.sex_at_birth][patient.age]['height']):
            if patient.height <= height:
                closest_index = i
                break
        
        if closest_index is None:
            closest_index = len(percentile_data[patient.sex_at_birth][patient.age]['height']) - 1

        sist_50 = percentile_data[patient.sex_at_birth][patient.age]['Systolic 50th'][closest_index]
        sist_90 = percentile_data[patient.sex_at_birth][patient.age]['Systolic 90th'][closest_index]
        sist_95 = percentile_data[patient.sex_at_birth][patient.age]['Systolic 95th'][closest_index]
        sist_95_plus_12 = percentile_data[patient.sex_at_birth][patient.age]['Systolic 95th + 12mmHg'][closest_index]

        diast_50 = percentile_data[patient.sex_at_birth][patient.age]['Diastolic 50th'][closest_index]
        diast_90 = percentile_data[patient.sex_at_birth][patient.age]['Diastolic 90th'][closest_index]
        diast_95 = percentile_data[patient.sex_at_birth][patient.age]['Diastolic 95th'][closest_index]
        diast_95_plus_12 = percentile_data[patient.sex_at_birth][patient.age]['Diastolic 95th + 12mmHg'][closest_index]

        bp_percentile_1 = [None, None]
        bp_percentile_2 = [None, None]


        #print(patient.record_ID)
        """print(patient.age)
        ...
        if patient.age < 13:
            if len(patient.BP1) != 0:
                if patient.BP1[0] < sist_90:
                    bp_percentile_1[0] = '50: Systolic Normal'
                elif patient.BP1[0] < sist_95:
                    bp_percentile_1[0] = '90: Systolic Elevated'
                elif patient.BP1[0] < sist_95_plus_12:
                    bp_percentile_1[0] = '95: Systolic Hypertesnion Stage 1'
                else:
                    bp_percentile_1[0] = '95 plus 12: Systolic Hypertension Stage 2'

                if patient.BP1[1] < diast_90:
                    bp_percentile_1[1] = '50: Diastolic Normal'
                elif patient.BP1[1] < diast_95:
                    bp_percentile_1[1] = '90: Diastolic Elevated'
                elif patient.BP1[1] < diast_95_plus_12:
                    bp_percentile_1[1] = '95: Diastolic Hypertesnion Stage 1'
                else:
                    bp_percentile_1[1] = '95 plus 12: Diastolic Hypertension Stage 2'

            if len(patient.BP2) != 0:
                if patient.BP2[0] < sist_90:
                    bp_percentile_2[0] = '50: Systolic Normal'
                elif patient.BP2[0] < sist_95:
                    bp_percentile_2[0] = '90: Systolic Elevated'
                elif patient.BP2[0] < sist_95_plus_12:
                    bp_percentile_2[0] = '95: Systolic Hypertesnion Stage 1'
                else:
                    bp_percentile_2[0] = '95 plus 12: Systolic Hypertension Stage 2'

                if patient.BP2[1] < diast_90:
                    bp_percentile_2[1] = '50: Diastolic Normal'
                elif patient.BP2[1] < diast_95:
                    bp_percentile_2[1] = '90: Diastolic Elevated'
                elif patient.BP2[1] < diast_95_plus_12:
                    bp_percentile_2[1] = '95: Diastolic Hypertesnion Stage 1'
                else:
                    bp_percentile_2[1] = '95 plus 12: Diastolic Hypertension Stage 2'
            
            
            if None in bp_percentile_1:
                print(bp_percentile_2[0], ',', bp_percentile_2[1])
                return bp_percentile_2
            elif None in bp_percentile_2:
                print(bp_percentile_1[0], ',', bp_percentile_1[1])
                return bp_percentile_1
            else:
                print(bp_percentile_1[0], bp_percentile_1[1], ',', bp_percentile_2[0], bp_percentile_2[1])
                return bp_percentile_1, bp_percentile_2

        if (len(patient.BP1) != 0): 
            if patient.BP1[0] < 120 and patient.BP1[1] < 80:
                bp_percentile_1[0] = '50: Systolic Normal'
                bp_percentile_1[1] = '50: Diastolic Normal'
            elif patient.BP1[0] <= 120 and patient.BP1[0] < 130 and patient.BP1[1] < 80:
                bp_percentile_1[0] = '90: Systolic Elevated'
                bp_percentile_1[1] = '50: Diastolic Normal'
            elif patient.BP1[0] <= 130 and patient.BP1[0] < 139 and patient.BP1[1] <= 80 and patient.BP1[1] < 90:
                bp_percentile_1[0] = '95: Systolic Hypertesnion Stage 1'
                bp_percentile_1[1] = '95: Diastolic Elevated Hypertesnion Stage 1'
            else:
                bp_percentile_1[0] = '95 plus 12: Systolic Hypertension Stage 2'
                bp_percentile_1[1] = '95 plus 12: Diastolic Hypertension Stage 2' 
        
        if (len(patient.BP2) != 0):
            if patient.BP2[0] < 120 and patient.BP2[1] < 80:
                bp_percentile_2[0] = '50: Systolic Normal'
                bp_percentile_2[1] = '50: Diastolic Normal'
            elif patient.BP2[0] <= 120 and patient.BP2[0] < 130 and patient.BP2[1] < 80:
                bp_percentile_2[0] = '90: Systolic Elevated'
                bp_percentile_2[1] = '50: Diastolic Normal'
            elif patient.BP2[0] <= 130 and patient.BP2[0] < 139 and patient.BP2[1] <= 80 and patient.BP2[1] < 90:
                bp_percentile_2[0] = '95: Systolic Hypertesnion Stage 1'
                bp_percentile_2[1] = '95: Diastolic Elevated Hypertesnion Stage 1'
            else:
                bp_percentile_2[0] = '95 plus 12: Systolic Hypertension Stage 2'
                bp_percentile_2[1] = '95 plus 12: Diastolic Hypertension Stage 2' 
...
if __name__ == "__main__":
    ...
    for patient in patients:
        #print([patient.record_ID, patient.sex_at_birth, patient.height, patient.age, patient.BP1, patient.BP2])
        #print(patient.record_ID)
        #print(patient.record_ID, 'C')
        patient.percentile_calculation(data.percentile)
        #break

    #patients[18].percentile_calculation(data.percentile)
