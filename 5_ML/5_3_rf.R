...
load(paste0(PATH_wk, "HP/results/5_1_split.RData"),verbose=TRUE)  #
...
plot(test_data$age_BP, test_data$pred_prob, col = ifelse(test_data$Y == "Yes", "red", "blue"), pch = 19,
...
print(orig_imp_df)
save(rf_mod, test_data, orig_imp_df, file = paste0(PATH_wk, "HP/results/5_3_random_forest.RData"))
