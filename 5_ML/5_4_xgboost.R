...
# 1) Your XGBoost training function
...
load(paste0(PATH_wk, "HP/results/5_1_split.RData"))
...
#save ROC plot 
jpeg(filename = paste0(PATH_wk, "HP/6_report/roc_xgb.jpeg"), width = 800, height = 600)
...
# 9) Save model
save(xgb_model, file = paste0(PATH_wk, "HP/results/5_4_xgboost.RData"))
